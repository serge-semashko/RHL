...
StdCall
function Send_Binary(cPort: Char; szCmd: PChar; iLen: Word): Word;
stdCall
function Receive_Binary(cPort: Char; szResult: PChar; wTimeOut: Word;
  wLen: Word; wT: Word): Word stdCall;

function DCON_Write_DO(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iDO_TotalCh: Word; lDO_Value: LongInt; iCheckSum: Word; iTimeOut: Word)
  : Word; StdCall;
{ ****************************************************************************
  iComPort: 1 ~ 255
...
function DCON_Write_DO_Bit(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iDO_TotalCh: Word; iBitValue: Word; iCheckSum: Word;
  iTimeOut: Word): Word; StdCall;
{ ***********************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
  iSlot: 0~7: for 8K and 87K series on i-8000 system
...
function DCON_Read_DI_Counter(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iDI_TotalCh: Word; iCheckSum: Word; iTimeOut: Word;
...
function DCON_Clear_DI_Counter(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iDI_TotalCh: Word; iCheckSum: Word; iTimeOut: Word)
  : Word; StdCall;
{ ******************************************************************
  iComPort: 1 ~ 255
...
function DCON_Write_AO(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iAO_TotalCh: Word; fValue: Single; iCheckSum: Word;
  iTimeOut: Word): Word; StdCall;
{ ***************************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
...
function DCON_Read_AO(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iAO_TotalCh: Word; iCheckSum: Word; iTimeOut: Word;
  fValue: PSingle): Word; StdCall;
{ ***********************************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
  iSlot: 0~7: for 8K and 87K series on i-8000 system
...
function DCON_Read_AI(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iAI_TotalCh: Word; iCheckSum: Word; iTimeOut: Word;
  iDataFormat: Word; fValue: PSingle; iValue: PWord): Word; StdCall;
{ *****************************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
  iSlot: 0~7: for 8K and 87K series on i-8000 system
...
function DCON_Read_Counter(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iCheckSum: Word; iTimeOut: Word; lCounter_Value: PDWord)
  : Word; StdCall;
{ *********************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
...
function DCON_Clear_Counter(iComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iCheckSum: Word; iTimeOut: Word): Word; StdCall;
{ *********************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
  iSlot: 0~7: for 8K and 87K series on i-8000 system
...
function DCON_READ_DIO_Latch(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iDI_TotalCh: Word; iDO_TotalCh: Word; iLatchType: Word; iCheckSum: Word;
  iTimeOut: Word; lDI_Latch_Value: PDWord; lDO_Latch_Value: PDWord;
  cDI_Latch_BitValue: PChar; cDO_Latch_BitValue: PChar): Word; StdCall;
{ ***************************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
  iSlot: 0~7: for 8K and 87K series on i-8000 system
...
function DCON_Read_Overflow(cComPort: Char; iAddress: Word; iSlot: ShortInt;
  iChannel: ShortInt; iCheckSum: Word; iTimeOut: Word; iOverflow: PWord)
  : Word; StdCall;
{ *******************************************************************
  iComPort: 1 ~ 255
  iAddress: 0 ~ 255: the RS-485 Address of module
...
function DCON_Write_DO;
  external 'DCON_PC.DLL' name 'DCON_Write_DO' function DCON_Write_DO_Bit;
  external 'DCON_PC.DLL' name 'DCON_Write_DO_Bit' function DCON_Read_DI_Counter;
  external 'DCON_PC.DLL' name 'DCON_Read_DI_Counter' function
  DCON_Clear_DI_Counter;
  external 'DCON_PC.DLL' name 'DCON_Clear_DI_Counter' function DCON_Write_AO;
  external 'DCON_PC.DLL' name 'DCON_Write_AO' function DCON_Read_AO;
  external 'DCON_PC.DLL' name 'DCON_Read_AO' function DCON_Read_AI;
  external 'DCON_PC.DLL' name 'DCON_Read_AI' function DCON_Read_Counter;
  external 'DCON_PC.DLL' name 'DCON_Read_Counter' function DCON_Clear_Counter;
  external 'DCON_PC.DLL' name 'DCON_Clear_Counter' function DCON_Read_DIO;
  external 'DCON_PC.DLL' name 'DCON_Read_DIO' function DCON_READ_DIO_Latch;
  external 'DCON_PC.DLL' name 'DCON_READ_DIO_Latch' function
  DCON_Clear_DIO_Latch;
  external 'DCON_PC.DLL' name 'DCON_Clear_DIO_Latch' function
  DCON_Read_Overflow;
  external 'DCON_PC.DLL' name 'DCON_Read_Overflow' function
  DCON_Get_Lib_Version; external 'DCON_PC.DLL' name 'DCON_Get_Lib_Version'
