...
//    curControl := curControl + trunc((target * 1.0 - mean3Voltage * 10000) * 20.98843441466855);
    curControl := curControl + trunc((target * 1.0 - CurVoltage * 10000) * 20.98843441466855);
...
var
    ...
    begin
        ...
        Counterseries.clear;
        psFullsp.Clear;
    spectrechart.RightAxis.Maximum := 100;
    spectrechart.LeftAxis.Maximum := 100;
...
//         fg,gb,b,bvvn
    ...
    begin
        ...
        for il1 := 0 to SpectreList. Count -1 do begin
          ...
          y:=StrToInt(s1)  * 1.0;
          if SpectreChart.LeftAxis.Maximum < y*1.1 then SpectreChart.LeftAxis.Maximum := y*1.1; 
          psFullsp.AddXY(x,y);
